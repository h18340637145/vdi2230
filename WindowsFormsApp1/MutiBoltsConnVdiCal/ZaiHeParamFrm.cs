...
namespace WindowsFormsApp1.MutiBoltsConnVdiCal
{
    public partial class ZaiHeParamFrm : ParamBaseFrm
    {
        ...
        public ZaiHeParamFrm()
        {
            ...
            dataGridView1.Rows.Add("Fao", 24900, "轴向载荷的上限值");
            dataGridView1.Rows.Add("Fau", 0, "轴向载荷的下限值");
            dataGridView1.Rows.Add("Mt", 0, "绕螺栓轴的扭矩");
            dataGridView1.Rows.Add("Fq", 0, "横向载荷");
            dataGridView1.Rows.Add("qf", 1, "载荷传递通过内部接合面数量");
            dataGridView1.Rows.Add("Mb", 0, "工作弯矩");
        ...
        public string dynamic_load { get; set; }
